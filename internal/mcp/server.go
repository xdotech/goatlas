...
func NewServer(cfg ServerConfig) *Server {
	...
	h := handler.NewMCPHandler(
		...
		usecase.NewGenerateEmbeddingsUseCase(cfg.Pool, cfg.Config.QdrantURL, vector.EmbedConfig{
			...
			OpenAIBaseURL:      cfg.Config.OpenAIBaseURL,
			OpenAIEmbedBaseURL: cfg.Config.OpenAIEmbedBaseURL,
			OpenAIAPIKey:       cfg.Config.OpenAIAPIKey,
			OpenAIModel:        cfg.Config.OpenAIEmbedModel,
		}),
